...
calculates the distance to the map coordinates under your mouse, and shows the
nearest 5-meter range beneath the money display in the mortar scope. It does
not click, press keys, read game memory, or aim the mortar.

The screen regions and scope display are calibrated for the 1920x1080 layout
...
6. Press **F8**.
7. Enter the mortar scope. A small range rounded to the nearest 5 m appears
   beneath the money display and hides when you leave the scope.
...
- **Scope range does not appear:** Calculate a target with F8 first, then enter
  the full mortar scope. The display only supports the calibrated 1920x1080 UI.
